...
const projects = {
  ...
  comic: {
    title: 'The Price of a Like',
    type: 'Comic · Illustration · Solo Project',
    sub: '2026 · Makerere University',
    role: 'Solo Designer — Illustration, Narrative, Colour',
    desc: 'A 13-page sequential narrative that critically explores contemporary digital culture, identity, and the performative nature of social media. Through detailed character turnarounds, intentional linework, and strategic colour application, the comic follows a protagonist navigating the psychological cost of seeking validation in a hyper-connected world.',
    highlights: ['13-page full sequential narrative arc','Detailed character turnaround sheets','Intentional linework as emotional language','Strategic colour application for mood shifts','Explores identity vs. online persona','Social media validation as narrative tension','Sequential panel composition & pacing','Hand-crafted illustration style throughout'],
    palette: ['#1C1A17','#C9A96E','#8B3A1E','#F2EDE4'],
    extra: { label: 'Themes', items: ['Digital identity & self-performance','Social validation & its psychological cost','Hyper-connectivity & isolation','The gap between reality and curated life','Vulnerability in a filtered world'] },
    quote: 'Every like is a transaction. What are you paying with?'
  }
};
